...
static double _YdcData[12] = { 0.0250,  0.0310,  0.0350,  0.0450,  0.0350,  0.0310,  0.0250,  0.0210,  0.0105,  0.0121,  0.0245,  0.0340 };		//  collective input affect on force out right wing
